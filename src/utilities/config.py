...
DP_EVENTS_DURATION = EVENTS_DURATION * 3  # Event duration of a Stepwise Node Discovery (in steps)
DP_FEEL_EVENT = D_FEEL_EVENT    # int: steps, a new DiscoveryPacket is felt (generated on the depot) every 'DP_FEEL_EVENT' steps. # ***
...
# if true and if the ROUTING_ALGORITHM selected is equal RoutingAlgorithm.QL
# the STEPWISE_NODE_DISCOVERY mode will be enabled
STEPWISE_NODE_DISCOVERY = True
...
# if true, the DP_DELAY representing the number of steps will be used as the transmission delay 
# from receiving a DiscoveryPacket to broadcasting it
MORE_OPTIONS = True
DP_DELAY = 110
