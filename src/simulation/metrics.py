...
class Metrics:
    ...
    def __init__(self, simulator):
        ...
        self.all_discovery_packets_generated_in_simulation = 0
        self.all_discovery_packets_sent = 0
        self.all_dpack_packets_in_simulation = 0
        self.all_neighbor_table_packets_in_simulation = 0
    ...
    def print_overall_stats(self):
        ...
        if self.simulator.stepwise_discovery_mode:
            print()
            print("Discovery packets generated during simulation: ", self.all_discovery_packets_generated_in_simulation)
            print("Discovery packets sent during the simulation: ", self.all_discovery_packets_sent)
            print("DPACK packets sent during the simulation: ", self.all_dpack_packets_in_simulation)
            print("NeighborTable packets sent during the simulation: ", self.all_neighbor_table_packets_in_simulation)
            print()
    ...
    def __dictionary_represenation(self):
        ...
        out_results["all_discovery_packets_generated_in_simulation"] = self.all_discovery_packets_generated_in_simulation
        out_results["all_discovery_packets_sent"] = self.all_discovery_packets_sent
        out_results["all_dpack_packets_in_simulation"] = self.all_dpack_packets_in_simulation
        out_results["all_neighbor_table_packets_in_simulation"] = self.all_neighbor_table_packets_in_simulation
